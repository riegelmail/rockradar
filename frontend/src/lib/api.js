// =========================================================================
// Data layer: talks to the RockRadar backend (/api/crags, /api/score) plus
// Open-Meteo (weather) and Nominatim (geocoding). Extracted verbatim from the
// previous App.jsx — the API contract, caching, and weather math are unchanged.
// =========================================================================
...
export async function scoreCrags({ home, maxHours, style, weather }) {
  return fetchJson(`${API_BASE}/api/score`, {
    method: "POST",
...
export { getCache, setCache, settle };
